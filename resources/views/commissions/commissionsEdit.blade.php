            ...
            <form action="/commission/{{ $commission->id }}" method="post">
                ...
                <div class="row mb-2">
                    <div class="col-md-6 form-group">
                        ...
                        @enderror
                        <input type="text" name="title" class="form-control" id="title" placeholder="Título de la comisión" value="{{ $commission->title }}">
                    </div>
                    <div class="col-md-6 form-group mt-3 mt-md-0">
                        @error('title')
                        <br>
                        @enderror
                        <input type="number" class="form-control" name="price" id="price" placeholder="Propina (no obligatoria)" value="{{ $commission->price }}">
                    </div>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <i class="text-danger">{{ $message }}</i><br>
                    @enderror
                    <textarea class="form-control" name="info" id="info" rows="5" placeholder="Descripción" >{{ $commission->info }}</textarea>
                </div>
